  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          SizedBox(height: 30),
          //sekarang kita buat navigation button
          Row(
            children: <Widget>[
              SizedBox(width: 10),
              GestureDetector(
          ...
          //Sekarang kita membuat album Art Disk
          Container(
          ...
          SizedBox(width: 10),
          //Sekarang kita buat Nama Artis yang sedang di putar
          Text(
            "You Need To Calm Down",
            style: TextStyle(fontSize: 25, fontWeight: FontWeight.w300),
          ),
          SizedBox(height: 20),
          //Sekarang kita buat musik bar nyaa
          Row(
          ...
          SizedBox(width: 10,),
          //sekarang kita ngebuat waktu di lagunya
